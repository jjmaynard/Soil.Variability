...
dataIn <- read_csv('C:/R_Drive/Data_Files/LPKS_Data/Projects/Soil_Function/SHAPE-main/Data/dataIn.csv') ## Read in your own data with same format
  ## Columns should be:
...
mod <- read_rds('C:/R_Drive/Data_Files/LPKS_Data/Projects/Soil_Function/SHAPE-main/Data/logitMod.rds')
