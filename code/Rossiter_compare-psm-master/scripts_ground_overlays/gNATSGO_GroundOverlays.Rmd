...
r.gnatsgo.4326 <- crop(r.gnatsgo.4326, bb.sub)
print(r.gnatsgo.4326)
plot(r.gnatsgo.4326, col=topo.colors(64))
```
...
GRD <- maptools::GE_SpatialGrid(r.sp.84, maxPixels=max(dim(r.gnatsgo.4326)[1:2]))
str(GRD)
```
